...
/*
 * @author: sunxiaoxiong
 * @date  : Created in 2020/4/15 9:47
 */
...
public class ProductLog {
    ...
    public String product() {
        ...
        while (true) {
            ...
            calleeName = phoneNameMap.get(caller);
        ...
        String duration = format.format((int) (30 * 60 * Math.random()));
        //拼接得到数据
    ...
    public static void main(String[] args) {
        if (args == null || args.length <= 0) {
            System.out.println("缺少参数，没有传入输出路径");
            return;
        }
        // String path = "D:\\callLog.csv";
